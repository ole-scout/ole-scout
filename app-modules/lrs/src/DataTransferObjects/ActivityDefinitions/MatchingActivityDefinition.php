...
class MatchingActivityDefinition extends ActivityDefinition
{
    public const INTERACTION_TYPE = 'matching';
    ...
    public function __construct(
        ...
        public array|Optional $source,
        /** @var list<InteractionComponent> */
        public array|Optional $target,
        /** @var list<string> */
